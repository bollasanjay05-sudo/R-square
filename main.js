const threeModulePromise = import('./assets/vendor/three.module.js')
  .catch(() => import('https://cdn.jsdelivr.net/npm/three@0.165.0/build/three.module.js'));
...
try {
  ...
  console.warn('The rotating Earth could not load because Three.js is unavailable.', error);
  return;
}
